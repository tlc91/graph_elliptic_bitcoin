...
def get_loaders(df, val_df, forecast_df, entire_df, config, 
    ...
    entire_dataset = ParamDataset(entire_df, features_list)
    # batch size of forecast loader = 1 to simplify filling in final model_curve df
    entire_loader = DataLoader(entire_dataset, batch_size=100, shuffle=False)    
    
    return train_loader, val_loader, forecast_loader, entire_loader